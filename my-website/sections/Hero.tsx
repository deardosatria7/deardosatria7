            ...
            <div className="lg:flex lg:justify-center lg:pt-10 lg:px-10">
              ...
              <div className="lg:flex-col">
                <div className="text-center px-10 pb-7 lg:text-left">
                  <h3 className="font-medium text-3xl text-sky-900 md:text-4xl dark:text-teal-400">
                    Deardo Satria
                  </h3>
                  <h4 className="font-medium text-md pt-1 pb-5 md:text-lg dark:text-white">
                    Lifelong learner
                  </h4>
                ...
                <div className="flex justify-center mb-4 gap-4 lg:justify-start lg:px-10">
                  <a
                    href="/about"
                    className="font-sans bg-gray-500 hover:bg-gray-600 text-white text-sm px-3 py-1 rounded-md dark:bg-neutral-700 dark:hover:bg-neutral-500"
                  >
                    About me
                  </a>
                  <Link href="/projects" legacyBehavior>
                    <a className="font-sans bg-gray-500 hover:bg-gray-600 text-white text-sm px-3 py-1 rounded-md dark:bg-neutral-700 dark:hover:bg-neutral-500">
                      Projects
                    </a>
                  </Link>
                </div>
